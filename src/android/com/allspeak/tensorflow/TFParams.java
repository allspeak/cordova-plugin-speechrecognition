...
public class TFParams
{
    ...
    public int nModelClass              = DEFAULT.MODEL_CLASS;
    ...
    public String[] saInputNodeName     = {DEFAULT.INPUT_NODENAME};   
            ...
            for(int i=0; i<len_labels; i++)
            {
                ...
                switch(field)
                {
                    ...
                    case "sModelFilePath":
                        ...
                        break;
                    case "saInputNodeName":
                        arrJson                 = init.getJSONArray("saInputNodeName");
                        saInputNodeName         = new String[arrJson.length()];
                        for(int s = 0; s < arrJson.length(); s++)
                            saInputNodeName[s]  = arrJson.getString(s);           
                        break;
                    ...
                    case "sLocalFolder":
                        ...
                        break;
                    case "commands":
                        arrJson                 = init.getJSONArray("commands");
...
//                if(commands.length != "nItems2Recognize")
    ...
    {
        public static int MODEL_CLASS               = ENUMS.TF_MODELCLASS_FF;        
